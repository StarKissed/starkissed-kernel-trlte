...
#define CPUFREQ_HARDLIMIT_MAX_SCREEN_ON_STOCK	1497600
...
#define CPUFREQ_HARDLIMIT_USER_ENBALED	1
#define CPUFREQ_HARDLIMIT_USER_DISABLED 0		/* default, hardlimit is disabled on boot */
