...
int dsi_tcon_mdnie_tune_cmd(struct samsung_display_driver_data *vdd, struct dsi_cmd_desc *dsi0_data, struct dsi_cmd_desc *dsi1_data, int tune_cnt);
#else
int dsi_tcon_mdnie_tune_cmd(struct samsung_display_driver_data *vdd, struct dsi_cmd_desc *dsi0_data, int tune_cnt);
#endif
...
#include "S6E3FA2_AMS510CV01/ss_dsi_panel_S6E3FA2_AMS510CV01.h" // Kcat 6
#include "S6E3HA0_AMS510CW01/ss_dsi_panel_S6E3HA0_AMS510CW01.h" // Lentis
#include "S6E3HA2_AMS567DJ01/ss_dsi_panel_S6E3HA2_AMS567DJ01.h" // TR
#include "S6E3HF2_AMS559DE01/ss_dsi_panel_S6E3HF2_AMS559DE01.h" // TB
/*	PANEL_HEADER END	*/
