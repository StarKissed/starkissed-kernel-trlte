...
HANDLE=TwistedZero
KERNELSPEC=/Volumes/android/trltetmo-kernel # repo filesystem location
KERNELREPO=$DROPBOX_SERVER/TwistedServer/Playground/kernels # output filesystem location
